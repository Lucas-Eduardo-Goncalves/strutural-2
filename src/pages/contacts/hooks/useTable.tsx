...
export const useTable = () => {
  ...
  const columns: ColumnsType<IRowData> = [
...

    {
      ...
      render: (_, row: IRowData) => <MaxWidthColumn width={180}>{(row.lastViewed ? moment(row.lastViewed).format('DD/MM/YYYY HH:ii') : '---')}</MaxWidthColumn>,
      ...defaultColumnProps,
    },
