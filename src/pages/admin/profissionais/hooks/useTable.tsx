...
export const useTable = () => {
  ...
  const [dependences, setDependences] = useState<IDependences>({cidades: [] });
...
console.log( moment().format('YYYY-MM-DD'));
  ...
  const columns: ColumnsType<IRowData> = [
    {
      title: 'Nome',
      dataIndex: 'profissional_name',
      render: (_, row: IRowData) => <MaxWidthColumn width={180}>{row.profissional_name}</MaxWidthColumn>,
      ...defaultColumnProps,
    },
    {
      title: 'Último Acesso',
      dataIndex: 'last_viewed',
      render: (_, row: IRowData) => <MaxWidthColumn width={180}>{(row.last_viewed ? moment(row.last_viewed).format('DD/MM/YYYY') : '---')}</MaxWidthColumn>,
      ...defaultColumnProps,
    },
    
    {
      title: 'CPF',
      dataIndex: 'CPF',
      render: (_, row: IRowData) => <MaxWidthColumn width={180}>{row.CPF}</MaxWidthColumn>,
      ...defaultColumnProps,
    },

    {
      title: 'Telefone',
      dataIndex: 'phone',
      render: (_, row: IRowData) => <MaxWidthColumn width={180}>{row.phone}</MaxWidthColumn>,
      ...defaultColumnProps,
    },
