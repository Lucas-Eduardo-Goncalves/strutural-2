...
export const useTable = () => {
  ...
  const columns: ColumnsType<IRowData> = [
    ...
    {
      title: 'Grau Escola',
      dataIndex: 'grauEscola',
      render: (_, row: IRowData) => <MaxWidthColumn width={180}>{row.grauEscola}</MaxWidthColumn>,
      ...defaultColumnProps,
    },
    {
      title: 'Cidade',
      dataIndex: 'cidadeName',
      render: (_, row: IRowData) => <MaxWidthColumn width={180}>{row.cidadeName}</MaxWidthColumn>,
      ...defaultColumnProps,
    },
      ...
      render: (_, row) => (
        <div className="table-actions">
          {statusSelected === 'Lixeira' ? (
            <Button className="btn-icon" type="info" onClick={() => {}} to="#" shape="circle">
